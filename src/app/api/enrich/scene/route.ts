...
export async function POST() {
  ...
  try {
    ...
    return NextResponse.json({ error: hideError(err, "api/enrich/scene", "Couldn't start that run — the app owner can find the details in the server logs.") }, { status: 500 });
  }
}
